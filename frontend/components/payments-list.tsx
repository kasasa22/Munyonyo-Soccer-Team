                ...
                <tr key={payment.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      payment.payment_type === "annual" ? "bg-purple-100 text-purple-800" :
                      payment.payment_type === "monthly" ? "bg-blue-100 text-blue-800" :
                      payment.payment_type === "pitch" ? "bg-green-100 text-green-800" :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end gap-2">
                      ...
                      <button 
                        onClick={() => handleDeletePayment(payment.id, payment.player_name, payment.amount)}
