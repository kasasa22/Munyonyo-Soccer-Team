              ...
              >
                <Avatar className="h-10 w-10 border-2 border-white shadow-sm">
                  <AvatarFallback className="bg-gradient-to-br from-blue-500 to-blue-700 text-white text-sm">
                    {getUserInitials(payment.player_name)}
                  </AvatarFallback>
                </Avatar>
                <div className="space-y-1 flex-1">
                  <p className="text-sm font-medium leading-none">{payment.player_name}</p>
                ...
                <Badge
                  className={`self-start sm:self-center ${getPaymentTypeColor(payment.payment_type)}`}
                  variant="secondary"
                >
